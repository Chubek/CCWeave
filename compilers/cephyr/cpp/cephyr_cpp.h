...
extern "C"
{
  ...
  char *cephyr_cpp_external (const char *source_path, const char *cpp_command,
                             char **error_message);

  char *cephyr_cpp_external_with_options (const char *source_path,
                                          const char *cpp_command,
                                          const char *const *options,
                                          int option_count,
                                          const char *const *args,
                                          int arg_count, char **error_message);
