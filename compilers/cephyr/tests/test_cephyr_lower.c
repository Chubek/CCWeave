...
static bool
function_has_opcode (const ccw_ir *ir, ccw_node fn, const char *opcode)
{
...
main (void)
{
  ...
  function->type->param_types
      = calloc (1, sizeof (*function->type->param_types));
  function->type->param_names
      = calloc (1, sizeof (*function->type->param_names));
