...
typedef enum {
  CCW_EXPR_OP_NEG, CCW_EXPR_OP_NOT, CCW_EXPR_OP_COM,
  CCW_EXPR_OP_ADD, CCW_EXPR_OP_SUB, CCW_EXPR_OP_MUL,
  CCW_EXPR_OP_DIV, CCW_EXPR_OP_MOD,
  CCW_EXPR_OP_SHL, CCW_EXPR_OP_SHR,
  CCW_EXPR_OP_AND, CCW_EXPR_OP_OR, CCW_EXPR_OP_XOR
} ccw_expr_op_t;
...
/* --- Directive kind --- */
typedef enum {
  CCW_DIR_SECTION, CCW_DIR_TEXT, CCW_DIR_DATA, CCW_DIR_BSS,
  CCW_DIR_GLOBAL, CCW_DIR_LOCAL, CCW_DIR_ALIGN,
  CCW_DIR_BYTE, CCW_DIR_2BYTE, CCW_DIR_4BYTE, CCW_DIR_8BYTE,
  CCW_DIR_ASCII, CCW_DIR_ASCIZ, CCW_DIR_ZERO, CCW_DIR_SPACE,
  CCW_DIR_EQU, CCW_DIR_SET, CCW_DIR_ARCH,
  CCW_DIR_MACRO, CCW_DIR_ENDM, CCW_DIR_INCLUDE,
  CCW_DIR_ERROR, CCW_DIR_WARNING,
  CCW_DIR_IFDEF, CCW_DIR_IFNDEF, CCW_DIR_ELSE, CCW_DIR_ENDIF
} ccw_dir_t;
