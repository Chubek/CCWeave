...
in `../adapters/`. The C and OCaml frontends build the checked-in runtime
and generated parsers from `third_party/tree-sitter/`,
`swaff/grammars/tree-sitter-c/`, and
`swaff/grammars/tree-sitter-ocaml/`; no parser generation, system package,
