...
static const char *const CCW_S7_R7RS
    = "(begin\n"
      ...
      "                 (reverse sets)\n"
      "                 (loop (cdr names) (+ i 1)\n"
      "                       (cons `(set! ,(car names) (list-ref args ,i)) "
      "sets))))))))\n"
      "\n"
...
static const char *const CCW_S7_PRELUDE
    = "(begin\n"
      ...
      "                 (apply inlet (map (lambda (n) (cons n (lib-env n))) "
      "',exports)))\n"
...
static const char *const CCW_S7_GUARDS
    = "(begin\n"
      ...
      "  (string-append (if (symbol? type) (symbol->string type) "
      "(object->string type))\n"
      "                 \": \"\n"
      ...
      "    (lambda (type info) (cons #f (ccw-condition->string type "
      "info)))))\n"
      "\n"
