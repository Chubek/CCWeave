;;; reassociate.scm
;;; CCWeave Kernel: Reassociates commutative integer chains to expose constant folding.
...
(define-library ((ccweave kernel reassociate))
  ...
  (begin
    ...
    (define (kernel-info)
      '((name        . reassociate)
        (version     . "1.0.0")
        (description . "Reassociates commutative integer chains to expose constant folding.")))
    ...
    (define (kernel-apply capability ir options)
      (unless (eq? capability 'opt.reassociation)
