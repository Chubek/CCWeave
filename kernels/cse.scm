;;; cse.scm
;;; CCWeave Kernel: Eliminates common subexpressions within extended basic blocks.
...
(define-library ((ccweave kernel cse))
  ...
  (begin
    ...
    (define (kernel-info)
      '((name        . cse)
        (version     . "1.0.0")
        (description . "Eliminates common subexpressions within extended basic blocks.")))
    ...
    (define (kernel-apply capability ir options)
      (unless (eq? capability 'opt.cse)
        (error "cse: unsupported capability" capability))
