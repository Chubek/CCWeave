;;; peephole.scm
;;; CCWeave Kernel: Local window rewrites over adjacent instruction pairs.
...
(define-library ((ccweave kernel peephole))
  ...
  (begin
    ...
    (define (kernel-info)
      '((name        . peephole)
        (version     . "1.0.0")
        (description . "Local window rewrites over adjacent instruction pairs.")))
    ...
    (define (kernel-apply capability ir options)
      (unless (eq? capability 'opt.peephole)
