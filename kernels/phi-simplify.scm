;;; phi-simplify.scm
;;; CCWeave Kernel: Removes trivial and duplicate phi nodes.
...
(define-library ((ccweave kernel phi-simplify))
  ...
  (begin
    ...
    (define (kernel-info)
      '((name        . phi-simplify)
        (version     . "1.0.0")
        (description . "Removes trivial and duplicate phi nodes.")))

    (define (kernel-capabilities)
      '(opt.phi-simplification))
    ...
    (define (kernel-apply capability ir options)
      (unless (eq? capability 'opt.phi-simplification)
