...
{
    ccw_kliche_opnd ops[] = { CCW_K_FUNC(code_symbol),
                              CCW_K_INT(captured_count), CCW_K_END };
...
ccw_node ccw_kliche_closure_ref(ccw_ir *ir, ccw_node blk, const char *dest,
                                const char *closure_reg, int slot)
{
    ccw_kliche_opnd ops[] = { CCW_K_REG(closure_reg), CCW_K_INT(slot), CCW_K_END };
...
{
    ccw_kliche_opnd ops[] = { CCW_K_REG(closure_reg), CCW_K_REG(arg_reg), CCW_K_END };
