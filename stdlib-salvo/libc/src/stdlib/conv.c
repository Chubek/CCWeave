...
static unsigned long long salvo_strtoull_core(const char *s, char **endptr,
                                              int base, int *neg, int *any)
{
    const char *p = s;
...
long strtol(const char *s, char **endptr, int base)
{
    int neg = 0;
    int any = 0;
    unsigned long long value = salvo_strtoull_core(s, endptr, base,
                                                   &neg, &any);
    if (!any)
        return 0;
    if (neg) {
